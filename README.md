...
**Captain Compose** is a lightweight deployment agent that applies `docker-compose.yaml` files using the Docker engine — without requiring a full orchestration platform.
